...
export default function Header() {
  ...
  if (pathname.startsWith("/manager") || pathname.startsWith("/pos"))
    return null;
      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center">
          ...
          <div className="ml-auto flex items-center space-x-8">
            ...
            >
              {[
                ...(isLoggedIn && role === ROLE_CODE_SHOP_OWNER
                  ? [{ href: "/pos", label: "POS" }]
                  : []),
                ...
                >
                  ...
                  {isActive(item.href) && (
                    <span
                      ...
                      style={{
                        transform:
                          "translateX(-50%) rotate(45deg) translateZ(8px)",
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex items-center gap-2 py-1.5 pl-1 pr-2.5 rounded-full bg-gray-100/80 hover:bg-gray-200/80 transition focus:outline-none">
                      ...
                      <span className="font-medium text-gray-700 text-sm max-w-25 truncate">
                        {username || "Tài khoản"}
                      </span>
                      {role === "ADMIN" && (
