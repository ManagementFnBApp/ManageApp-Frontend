...
export default function ManagerPage() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('focus', refreshActive);
  }, []);
    ...
    <div className="flex flex-col gap-6 px-6 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        <button
          ...
          className={`relative flex flex-col items-center justify-center gap-2 h-28 sm:h-32 rounded-xl font-semibold shadow-sm transition-all active:scale-[0.98] ${
