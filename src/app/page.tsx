          ...
          <div className="max-w-2xl">
            <div className="space-y-8">
              <h1
                ...
                style={{ letterSpacing: '-0.02em', textShadow: '0 2px 4px rgba(255,255,255,0.5)' }}
              >
                Phần mềm quản lý bán hàng phổ biến nhất
              </h1>
              <p
                className="text-xl md:text-2xl text-gray-800 leading-relaxed"
                style={{ fontWeight: '500', textShadow: '0 1px 2px rgba(255,255,255,0.5)' }}
              >
              ...
              <div className="grid grid-cols-2 gap-6 pt-8">
                <div
                  className="text-left rounded-2xl p-6 border-2 border-blue-200"
                  style={{
                ...
                >
                  <div className="text-4xl md:text-5xl font-bold text-blue-600 mb-2">300.000+</div>
                  <div className="text-gray-800 text-sm md:text-base font-medium">nhà kinh doanh sử dụng</div>
                </div>
                <div
                  className="text-left rounded-2xl p-6 border-2 border-blue-200"
                  style={{
                ...
                >
                  ...
                  <div className="text-gray-800 text-sm md:text-base font-medium">nhà kinh doanh mới mỗi tháng</div>
                </div>
              </div>
            </div>
          </div>
