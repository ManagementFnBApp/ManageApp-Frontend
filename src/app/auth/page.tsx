...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-slate-100 py-12 px-4">
               ...
               <div 
                 ...
                 style={{
                   ...
                   transform: isAnimating 
                     ? (isLogin ? 'translateX(-30px)' : 'translateX(30px)')
                     : 'translateX(0)',
                 }}
               >
                 <h2 
                 ...
                 <p 
                   ...
                   style={{ textShadow: '0 2px 20px rgba(0,0,0,0.8), 0 1px 8px rgba(0,0,0,0.6)' }}
                 ...
                 {isLogin ? (
                   ...
                   >
                     ...
                     <form onSubmit={handleLoginSubmit} className="space-y-5">
                       ...
                       <button
                         type="submit"
                         className="w-full text-white py-3.5 rounded-xl font-semibold transition-all hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 animate-[slideUp_0.7s_ease-out_0.4s_both]"
                         style={{ 
                   ...
                   >
                     ...
                     <form onSubmit={handleRegisterSubmit} className="space-y-4">
                       ...
                       <button
                         type="submit"
                         className="w-full text-white py-3.5 rounded-xl font-semibold transition-all hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 mt-6 animate-[slideUp_0.7s_ease-out_0.3s_both]"
                         style={{ 
                           background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
                         }}
                       >
