...
export default function CheckoutOrderPage() {
  ...
  /**
   * handleConfirm – Simulate order creation.
   * Replace the body of the try block with your real API call when ready:
   *   const order = await createPosOrder({ items: cart.items, paymentMethod: selectedMethod });
   */
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6">Vui lòng thêm sản phẩm từ màn hình POS trước khi thanh toán.</p>
          <Link
            href="/pos"
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-white px-4 pt-20">
        <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-md w-full text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Đơn hàng thành công!</h2>
          ...
          <div className="bg-blue-50 rounded-xl p-4 mb-8 text-left space-y-2">
            ...
            <div className="flex justify-between text-sm border-t border-blue-100 pt-2 mt-2">
              ...
              <span className="font-bold text-blue-600 text-base">{formatPrice(cart?.total ?? 0)}</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg p-8 sticky top-8">
              ...
              <div className="border-t border-gray-100 pt-4 flex justify-between items-center">
                ...
                <span className="text-2xl font-bold text-blue-600">{formatPrice(cart?.total ?? 0)}</span>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="mb-8 bg-yellow-50 border border-yellow-200 rounded-xl p-5">
                ...
                {selectedMethod === 'CASH' && (
                  <p className="text-sm text-yellow-700">Nhận tiền mặt từ khách và trao lại hóa đơn / biên lai.</p>
                )}
                {selectedMethod === 'BANK_TRANSFER' && (
                  <div className="text-sm text-yellow-700 space-y-1">
                    <p><strong>Ngân hàng:</strong> Vietcombank</p>
                    <p><strong>Số tài khoản:</strong> 1234 5678 9012</p>
                    <p><strong>Chủ TK:</strong> MANAGE APP CO., LTD</p>
                  </div>
                )}
                {selectedMethod === 'MOMO' && (
                  <p className="text-sm text-yellow-700">Hướng dẫn khách quét mã QR MoMo tại quầy.</p>
                )}
                {selectedMethod === 'VNPAY' && (
                  <p className="text-sm text-yellow-700">Hướng dẫn khách quét mã VNPay tại quầy hoặc thanh toán qua app.</p>
                )}
              </div>
