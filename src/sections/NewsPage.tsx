...
export default function NewsPage() {
  const featured = {
    ...
    excerpt: 'Công nghệ AI mới giúp doanh nghiệp dự đoán chính xác nhu cầu khách hàng',
    date: '27/01/2026',
    category: 'Sản phẩm',
    image: '🤖',
    readTime: '5 phút đọc',
            ...
            {news.map((a, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-gray-900 line-clamp-2">{a.title}</h3>
