    ...
    <div className="pt-20">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-900">Liên hệ với chúng tôi</h2>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-900">Tài nguyên hỗ trợ</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {guides.map((g, i) => (
              <Link
                key={i}
            ...
            {faqs.map((s, si) => (
              <div key={si}>
                <h3 className="text-2xl font-bold mb-6 text-gray-900 flex items-center">
                  <span className="w-2 h-8 bg-blue-600 rounded mr-3" />
                  {s.category}
                </h3>
